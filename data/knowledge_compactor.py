...
CURATED_FACTS = [
    ...
    "F|runtime.errors|VERSION_MISMATCH=refresh_version;NO_IDENTITY=register_erc8004;SC_WALLET_NOT_FOUND=create_sc_wallet;AGENT_NOT_WHITELISTED=request_whitelist;INSUFFICIENT_BALANCE=topup;ACTION_COOLDOWN=wait",
