...
class ClawRuntimeGameplayGateTests(unittest.TestCase):
    def test_active_free_game_is_treated_as_resume_signal(self) -> None:
        ...
        active_game = {
            "code": "ACTIVE_FREE_GAME_EXISTS",
            "guide": "references/sc-wallet-policy.md#active-game-free",
        }
        welcome = {
            "type": "welcome",
        ...
        account = {
            "ok": True,
            "readiness": {"freeRoom": {"ok": False, "missing": [active_game]}},
        }
    ...
    def test_active_free_game_does_not_mask_other_free_blockers(self) -> None:
        ...
        self.assertFalse(
            claw_runtime.account_free_ready(
                {"ok": True, "readiness": welcome["readiness"]}
            )
        )
